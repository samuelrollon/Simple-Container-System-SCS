...
<body>
    ...
    <?php
        ...
        if ($lider == 'todos') {
            ...
            echo "<a href='http://dashboard.local.scs/projects/new_project.php'>Volver...</a>";
            echo "</div>";
            exit;
        }
        ...
        $query = "INSERT INTO projects (title, project_lead,department,start_date,end_date,state,details) VALUES ('".$titulo."',".$lider.",'".$departamento."','".$fecha_inicio."','".$fecha_fin."','".$estado."','".$detalles."');";
